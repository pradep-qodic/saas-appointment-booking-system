...
<head>
    ...
    <link href="<?php echo admin_base_url('themes/admin/css/bootstrap-social.css'); ?>" rel="stylesheet"/>
    <link href="<?php echo admin_base_url('themes/admin/css/bootstrap-responsive.min.css'); ?>" rel="stylesheet"/>
    <link href="<?php echo admin_base_url('themes/admin/css/font-awesome.css'); ?>" rel="stylesheet"/>
    <!-- Javascript -->
    <script src="<?php echo admin_base_url('themes/admin/js/jquery_min.js'); ?>"></script>
