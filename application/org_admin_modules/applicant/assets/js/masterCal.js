...
function loadTimeSlots(DATE){
	...
	$.ajax({
        type:"post",
        data:{selected_date:DATE,mPageId:id,timezone:timezn},
        url: $("#current_url").val()+'/loadTimeSlotsMaster',
        success: function(data){
			$("#orgslots").html("");
...
function fullCal(){
	...
	$("#loadingCal").remove();
	$('#calendarMaster').fullCalendar('destroy');
	$('#calendarMaster').fullCalendar({
		theme:true,
		defaultView:'month',
		...
		dayRender: function (date, cell) {
			$("#calendarMaster .fc-day.fc-past").css('background',"#ebebeb");
		},
		eventSources: [
        // your event source
        {
