...
<?php //if(!isset($pageDisabled) || !$pageDisabled): ?>
	...
	<input type="hidden" id="calId" value="<?php if(isset($calId) && $calId)echo $calId;?>" />
	...
	<script type="text/javascript" src='<?php echo base_url().'frames/assets/js/administrativeCal.js'; ?>'></script>
