...
<div class="container">
	...
	<div class="row" id="containerAppointmentRow">
			<!-- <div class="col-md-3" id="leftSide">
				<div style="min-height: 320px;margin-top: 52px;">
					...
					<div class="form-group">
						...
						<h5><?php echo $pageInfo[0]->location;?></h5>
					</div>
					<?php endif;?>
					<hr/>
				</div>
			...
			<?php else: ?>
				<div class="col-xs-12 col-md-12 well" id="middleSide">
					<div class="col-xs-9 col-md-9">
						<div id="calendar" style="margin:0;"></div>
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3 pull-right" style="border: 1px solid #ebebeb;overflow: auto;">
				...
				<div class="well col-md-6 col-xs-12 col-sm-6 col-md-offset-3 col-sm-offset-3" id="appointmentForm" style="display:none;">
...
<?php if(!isset($pageDisabled) || !$pageDisabled): ?>
	...
	<input type="hidden" id="loadHolidayURL" value="<?php echo base_url().'frames/loadholidaysData'; ?>"/>
	...
	<link href='<?php echo base_url().'frames/assets/css/jquery-ui.theme.css'; ?>' rel='stylesheet' />
	...
	<script type="text/javascript" src='<?php echo base_url().'frames/assets/js/frames.js'; ?>'></script>
	<?php if(isset($displayTimezone) && $displayTimezone):?>
