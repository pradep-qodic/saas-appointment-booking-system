...
<div style="margin-top: 20px;">
		...
		<div role="tabpanel">
		  ...
		  <div class="tab-content" style="/*margin-top: 20px;border: 1px solid black; min-height: 450px; */">
		    <div role="tabpanel" class="tab-pane active" id="activity_stream">
		    	<div class="well" style="background-color:lightblue;display: none !important;">
		    		<div class="row">
	...
	<div class="col-md-12" style="margin-top: 20px;">
		<legend></legend>
		<fieldset class="col-md-4" style="display:none;">
...
<input type="hidden" id="base_url" value="<?php  echo base_url()."frames"; ?>"/>
...
<script type="text/javascript" src='<?php echo base_url1().'frames/assets/js/admins_js.js'; ?>'></script>
